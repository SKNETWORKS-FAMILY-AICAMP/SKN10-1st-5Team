...
화면 설계할 때는 기능을 설정하고 그 다음에 무엇을 해야할지 몰라서 chatgpt에게 물어보고 생각해서 기능을 하나씩 정해보고 </br>
그래프를 그릴 때는 대략적인 틀을 팀장님이 알려주셔서 해결하고</br>
그래프그리는데는 인터넷 자료를 참고해서 그리는데</br>
그래프는 직접 코딩하니까 오류가 나서</br>
코딩할 수 있는 부분까지만 입력하고 모르는 부분은 chatgpt에게 물어보고 수정하고 해서</br>
